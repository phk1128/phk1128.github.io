...
tags: [Spring, 객체 지향, Spring DI, 추상화, 다형성]
image: assets/img/spring_logo.png
---
...
먼저 예제에 사용될 SpringBoot의 애노테이션 부터 설명하겠습니다. 
...
결과적으로 인터페이스를 통해 추상화와 다형성을 활용함으로써 비즈니스 로직을 수정할 필요가 없게 됩니다.<br>
그러면 이제 위 코드에서 사용된 Spring 애노테이션의 역할을 설명 드리겠습니다.
